...
namespace PrivatesquaresWebApiNew.Persistance.Data
{
    ...
    public partial class EWT_PSQNEWEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetParentCategory_Result> GetParentCategory(Nullable<long> parentCatId)
        {
            var parentCatIdParameter = parentCatId.HasValue ?
                new ObjectParameter("ParentCatId", parentCatId) :
                new ObjectParameter("ParentCatId", typeof(long));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetParentCategory_Result>("GetParentCategory", parentCatIdParameter);
        }
